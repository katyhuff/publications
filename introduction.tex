...
We explore the feasibility of using \gls{UNF} from 
other European Union nations to support French transition into a \gls{SFR} 
        fleet without additional construction of \glspl{LWR}.  \Cyclus nuclear 
        fuel cycle simulations
        tracked \gls{UNF} masses and tails inventories across 
        the European Union between 1950 and 2160, and projected a transition to 
        110 \glspl{SFR} (66GWe). These simulations
        concluded that France can avoid deployment of 
        additional \glspl{LWR} by accepting \gls{UNF} from other EU nations.  
\end{abstract}
