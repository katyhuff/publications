...
inventory in \gls{EU} member states through 2050, and subsequently evaluated a 
...
However, this work overlooked the potential to reprocess legacy \gls{UNF} from other
\gls{EU} nations to produce \gls{MOX} fuel for French \glspl{SFR}.
...
Historical nuclear reactor deployment data for all \gls{EU} nations comprised 
the scenario definition from  
